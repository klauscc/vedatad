...
model = dict(
    ...
    backbone=dict(
        ...
        pretrained_model="data/pretrained_models/timesformer/TimeSformer_divST_96x4_224_K600.pyth",
    ),
    neck=[
        dict(
...
train_engine = dict(
    ...
    membank=dict(
        ...
        mode="random",
        mem_bank_meta_file=f"data/tmp/eccv2022/thumos14/memory_mechanism/{expid}/timesformer_96x4_15fps_256x256_crop224x224/meta_val.json",
        mem_bank_dir=f"data/tmp/eccv2022/thumos14/memory_mechanism/{expid}/timesformer_96x4_15fps_256x256_crop224x224/val",
    ),
    model=model,
    criterion=dict(
