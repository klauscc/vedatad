...
train_engine = dict(
    ...
    membank=dict(
        ...
        mode="random",
        mem_bank_meta_file=f"data/tmp/eccv2022/rebuttal/thumos14/memory_mechanism/{expid}/feat_swinb_15fps_256x256_crop224x224/meta_val.json",
        mem_bank_dir=f"data/tmp/eccv2022/rebuttal/thumos14/memory_mechanism/{expid}/feat_swinb_15fps_256x256_crop224x224/val",
    ),
    model=model,
    criterion=dict(
