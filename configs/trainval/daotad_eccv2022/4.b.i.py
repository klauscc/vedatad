...
train_engine = dict(
    ...
    membank=dict(
        ...
        mode="random",
        mem_bank_meta_file=f"data/tmp/eccv2022/thumos14/memory_mechanism/{expid}/feat_swint_15fps_128x128_crop112x112/meta_val.json",
        mem_bank_dir=f"data/tmp/eccv2022/thumos14/memory_mechanism/{expid}/feat_swint_15fps_128x128_crop112x112/val",
    ),
    model=model,
    criterion=dict(
